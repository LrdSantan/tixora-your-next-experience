-- Tickets issued after verified Paystack payment (rows inserted via finalize_purchase_after_payment RPC from Edge Function)
...
-- Called only with service_role from Edge Function (not granted to anon/authenticated)
