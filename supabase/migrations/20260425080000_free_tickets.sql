-- Update finalize_purchase_after_payment to handle free tickets and include underpayment check
...
BEGIN
  ...
  -- Underpayment Check [Free Ticket Tier Support]
  -- expected_total is in kobo, p_verified_amount_kobo is in kobo
